    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <form>
                ...
                <div>
                    <label>水温</label>
                    <input v-model="dairyData.lowest_water_temperature" type="number" step="0.5" min="0" class="form-control" id="lowest_water_temperature" placeholder="最低水温(℃)">
                    <input v-model="dairyData.highest_water_temperature" type="number" step="0.5" min="0" class="form-control" id="highest_water_temperature" placeholder="最高水温(℃)">
                </div>
                <div>
